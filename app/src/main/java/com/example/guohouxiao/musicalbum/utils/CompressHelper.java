...
public class CompressHelper {
    ...
    public File compressToFile(File file) {
        return BitmapUtils.compressImage(context, Uri.fromFile(file), maxWidth, maxHeight,
    ...
    public Bitmap compressToBitmap(File file) {
        return BitmapUtils.getScaledBitmap(context, Uri.fromFile(file), maxWidth, maxHeight, bitmapConfig);
    }
